...
typedef enum
{
    THREAD_INPUT_ERROR_INIT_LIGHT                           = 0x00000001U,
    THREAD_INPUT_ERROR_HANDLE_LIGHT                         = 0x00000002U,
    THREAD_INPUT_ERROR_INIT_TEMPERATURE                     = 0x00000004U,
    THREAD_INPUT_ERROR_HANDLE_TEMPERATURE                   = 0x00000008U,
    THREAD_INPUT_ERROR_INIT_HUMIDITY                        = 0x00000010U,
    THREAD_INPUT_ERROR_HANDLE_HUMIDITY                      = 0x00000020U,
    THREAD_INPUT_ERROR_INIT_BATTERY                         = 0x00000040U,
    THREAD_INPUT_ERROR_HANDLE_BATTERY                       = 0x00000080U,
